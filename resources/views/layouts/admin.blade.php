...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ asset('admin_asset/ionicons/css/ionicons.min.css') }}">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('admin_asset/dist/img/AdminLTELogo.png') }}" alt="UQIMEDIA App" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">UQIMEDIA App</span>
    </a>
